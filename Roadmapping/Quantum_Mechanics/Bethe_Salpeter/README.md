...
|---|---|---|---|---|
| **PR A** | §§1–7 — Non-rel hydrogen | scaffold + non-rel reduction `K → p²/2m + V₀` | 3–4 | in progress |
| **PR B** | §§8–13 — Matrix elements + transitions | dipole, multipole, oscillator strengths | 3–4 | pending |
| **PR C** ⭐ | **§14 Fine structure (pivot)** | Dirac vs dual Dirac for H 2P₃/₂ – 2P₁/₂ | 3–4 | pending |

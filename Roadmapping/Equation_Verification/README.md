...
| FOUNDATIONS FOR QED I: MATHEMATICAL | [FOUNDATIONS_FOR_QED_I_MATHEMATICAL.md](FOUNDATIONS_FOR_QED_I_MATHEMATICAL.md) | core ✅ | ✅ | Minkowski Incompatible Theorem 1.1 verified; HK-integrability example 3.3 (F = t² sin(1/t²)) ✅; KS-Hilbert space construction sketch verified. Sec 3-4 deep results cross-referenced. |
| FoundationsII-Classical | [FoundationsII-Classical.md](FoundationsII-Classical.md) | core ✅ + Q3 resolved | ✅ ⭐ | Sec 2.2 supplies the explicit derivation of the $r_0$ critical-point claim from Maxwell paper, **resolving Open Question 3**. Three K forms (Eqs 2.6, 2.8, 2.9 = TCEP 5.4-5.7). Wolfram MCP confirms attractive/zero/repulsive force sign. |

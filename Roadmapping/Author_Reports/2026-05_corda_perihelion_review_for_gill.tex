...
the Corda-style \texttt{pim/M\ +\ relativistic\ correction} template
(the chain analysed in PR
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textbackslash{}frac\{GMm\}\{r\_0\^{}2\} = \textbackslash{}frac\{m v\_0\^{}2\}\{r\_0\}     \textbackslash{}qquad (3)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{v\_0 = \textbackslash{}sqrt\{GM/r\_0\}                          \textbackslash{}qquad (4)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{T\_0 = \textbackslash{}frac\{2\textbackslash{}pi r\_0\}\{v\_0\} = \textbackslash{}frac\{2\textbackslash{}pi r\_0\^{}\{3/2\}\}\{\textbackslash{}sqrt\{GM\}\}  \textbackslash{}qquad (5)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textbackslash{}omega\_0 = 2\textbackslash{}pi / T\_0                         \textbackslash{}qquad (6)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textbackslash{}varphi\_0 = \textbackslash{}omega\_0 T\_0 = 2\textbackslash{}pi               \textbackslash{}qquad (7)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textbackslash{}frac\{G(M+m)m\}\{r\_0\^{}2\} = \textbackslash{}frac\{m v\^{}2\}\{r\_0\}     \textbackslash{}qquad (8)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textbackslash{}vec F\_G = \textbackslash{}frac\{GMm\}\{r\_0\^{}2\}\textbackslash{}hat u\_r           \textbackslash{}qquad (9)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{M a\_s\textbackslash{}hat u\_r = \textbackslash{}frac\{GMm\}\{r\_0\^{}2\}\textbackslash{}hat u\_r \textbackslash{};\textbackslash{}Rightarrow\textbackslash{}; a\_s = \textbackslash{}frac\{Gm\}\{r\_0\^{}2\}  \textbackslash{}qquad (10)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{m a\_m\textbackslash{}hat u\_r = {-}\textbackslash{}frac\{GMm\}\{r\_0\^{}2\}\textbackslash{}hat u\_r \textbackslash{};\textbackslash{}Rightarrow\textbackslash{}; a\_m = {-}\textbackslash{}frac\{GM\}\{r\_0\^{}2\}  \textbackslash{}qquad (11)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{a\textbackslash{}hat u\_r \textbackslash{}equiv a\_m {-} a\_s = {-}\textbackslash{}frac\{G(M+m)\}\{r\_0\^{}2\}\textbackslash{}hat u\_r  \textbackslash{}qquad (12)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{F\textbackslash{}hat u\_r = {-}\textbackslash{}frac\{G(M+m)m\}\{r\_0\^{}2\}\textbackslash{}hat u\_r     \textbackslash{}qquad (13)}
\end{Highlighting}
\end{Shaded}
...
acceleration of Mercury w.r.t. the Sun is bigger than \texttt{GM/r\^{}2}
by the factor \texttt{(M+m)/M\ =\ 1\ +\ m/M}.
...
one-body problem for a reduced-mass particle \texttt{mu\ =\ Mm/(M+m)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{v = \textbackslash{}sqrt\{G(M+m)/r\_0\}                          \textbackslash{}qquad (14)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{T = \textbackslash{}frac\{2\textbackslash{}pi r\_0\}\{v\} = \textbackslash{}frac\{2\textbackslash{}pi r\_0\^{}\{3/2\}\}\{\textbackslash{}sqrt\{G(M+m)\}\}  \textbackslash{}qquad (15)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(M+m)\^{}\{{-}1/2\} = M\^{}\{{-}1/2\}\textbackslash{},(1 + m/M)\^{}\{{-}1/2\}      \textbackslash{}qquad (16)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{T = T\_0\textbackslash{},(1 + m/M)\^{}\{{-}1/2\}                      \textbackslash{}qquad (17)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textbackslash{}omega = \textbackslash{}omega\_0\textbackslash{},(1 + m/M)\^{}\{1/2\}             \textbackslash{}qquad (18)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textbackslash{}varphi = \textbackslash{}omega T\_0 = 2\textbackslash{}pi\textbackslash{},(1 + m/M)\^{}\{1/2\} \textbackslash{}simeq 2\textbackslash{}pi\textbackslash{},(1 + m/(2M))  \textbackslash{}qquad (19)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textbackslash{}boxed\{\textbackslash{};\textbackslash{}Delta\textbackslash{}varphi = \textbackslash{}varphi {-} \textbackslash{}varphi\_0 \textbackslash{}simeq \textbackslash{}pi m / M\textbackslash{};\}  \textbackslash{}qquad (20)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{(* Result: Pi x {-} Pi x\^{}2/4 + O[x]\^{}3  [OK] leading term is pi m/M *)}
\end{Highlighting}
\end{Shaded}

\textbf{Algebra {[}OK{]}.} Numerically for Mercury
(\texttt{m/M\ =\ 1.66\ x\ 10\^{}-\^{}7}):
\texttt{Deltaphi\ =\ 5.21\ x\ 10\^{}-\^{}7\ rad/orbit\ x\ 415.2\ orbits/century\ x\ (180.3600/pi)}
...
angular velocity \texttt{omega}.} That is not a perihelion advance. The
...
\texttt{2pi}, \textbf{regardless of \texttt{T} and \texttt{omega}}.
Changing \texttt{G} from \texttt{GM} to \texttt{G(M+m)} rescales the
orbital speed and period but leaves the orbit a closed ellipse. The
\texttt{pim/M} quantity Corda computes is a real kinematic effect, but
it is not the perihelion-advance quantity. The §3 derivation makes this
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{F\_\{c0\}(r) = m\textbackslash{}left(\textbackslash{}ddot r {-} \textbackslash{}omega\_0\^{}2 r\textbackslash{}right)                  \textbackslash{}qquad (21)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{J\_0 = m r\^{}2 \textbackslash{}omega\_0                                              \textbackslash{}qquad (22)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{F\_\{c0\}(r) = m\textbackslash{}left(\textbackslash{}ddot r {-} \textbackslash{}frac\{J\_0\^{}2\}\{m\^{}2 r\^{}3\}\textbackslash{}right)         \textbackslash{}qquad (23)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{F\_\{c0\}(r\_0) = {-}\textbackslash{}frac\{J\_0\^{}2\}\{m r\_0\^{}3\}                              \textbackslash{}qquad (24)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textbackslash{}ddot x + m\^{}\{{-}1\}\textbackslash{}!\textbackslash{}left[{-}\textbackslash{}frac\{3 F\_\{c0\}(r\_0)\}\{r\_0\} {-} F\textquotesingle{}\_\{c0\}(r\_0)\textbackslash{}right] x = 0  \textbackslash{}qquad (27)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{T\_0 = 2\textbackslash{}pi\textbackslash{}!\textbackslash{}left(\textbackslash{}frac\{m\}\{{-}\textbackslash{},3 F\_\{c0\}(r\_0)/r\_0 {-} F\textquotesingle{}\_\{c0\}(r\_0)\}\textbackslash{}right)\^{}\{1/2\}  \textbackslash{}qquad (28)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textbackslash{}frac\{\textbackslash{}varphi\_0\}\{2\} = \textbackslash{}pi\textbackslash{}!\textbackslash{}left(\textbackslash{}frac\{m\}\{{-}3F\_\{c0\}/r\_0 {-} F\textquotesingle{}\_\{c0\}\}\textbackslash{}right)\^{}\{1/2\}\textbackslash{}!\textbackslash{}frac\{J\_0\}\{m r\_0\^{}2\}  \textbackslash{}qquad (29)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textbackslash{}boxed\{\textbackslash{};\textbackslash{}varphi\_0 = 2\textbackslash{}pi\textbackslash{}left[\textbackslash{},3 + \textbackslash{}frac\{F\textquotesingle{}\_\{c0\}(r\_0)\textbackslash{},r\_0\}\{F\_\{c0\}(r\_0)\}\textbackslash{},\textbackslash{}right]\^{}\{{-}1/2\}\textbackslash{};\}  \textbackslash{}qquad (31)}
\end{Highlighting}
\end{Shaded}

\textbf{Wolfram MCP for \texttt{F\ =\ -k/r\^{}2}:}
...
\CommentTok{(* Result: \{{-}2, 2 Pi\}  [OK] For inverse{-}square: F\textquotesingle{}r/F = {-}2, phi\_0 = 2pi, NO PRECESSION *)}
\end{Highlighting}
\end{Shaded}
...
setting F\_\{c0\} = F\_G in Eq. (31)\ldots{} one finds phi\_0 = 2pi,
which is exactly Eq. (7)''}), and explicitly notes that this is the
closed-orbit result. \textbf{For an inverse-square force, the apsidal
angle is 2pi, the orbit is closed, and there is no precession.} Verified
by Wolfram MCP
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{F\_\{c0\}(r) \textbackslash{};\textbackslash{}to\textbackslash{}; F\_c(r) = \textbackslash{}left(1 + \textbackslash{}frac\{m\}\{M\}\textbackslash{}right) F\_\{c0\}(r)  \textbackslash{}qquad (32)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textbackslash{}omega\_0 \textbackslash{}to \textbackslash{}omega                                                \textbackslash{}qquad (33)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{J\_0 \textbackslash{}to J = m r\^{}2 \textbackslash{}omega                                           \textbackslash{}qquad (34)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{F\textquotesingle{}\_c(r\_0) = \textbackslash{}left(1 + \textbackslash{}frac\{m\}\{M\}\textbackslash{}right) F\textquotesingle{}\_\{c0\}(r\_0)              \textbackslash{}qquad (36)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textbackslash{}boxed\{\textbackslash{};\textbackslash{}frac\{F\textquotesingle{}\_c(r\_0)\}\{F\_c(r\_0)\} \textbackslash{};=\textbackslash{}; \textbackslash{}frac\{F\textquotesingle{}\_\{c0\}(r\_0)\}\{F\_\{c0\}(r\_0)\}\textbackslash{};\}  \textbackslash{}qquad (37)}
\end{Highlighting}
\end{Shaded}
...
unscaled force \texttt{F\_\{c0\}} --- which is \texttt{2pi} (Eq. 31 with
\texttt{F\_\{c0\}\ =\ F\_G\ =\ -k/r\^{}2}). \textbf{The ``perturbed''
force still gives a closed orbit. No precession.}

Corda's subsequent Eqs. (38)--(41) derive
\texttt{T\ =\ T\_0(1+m/M)\^{}(-1/2)} again from the period formula (28),
then \texttt{omega\ =\ omega\_0(1+m/M)\^{}(1/2)}, then
\texttt{phi\ =\ omega\ T\_0\ \textasciitilde{}=\ 2pi(1\ +\ m/(2M))} ---
the same \texttt{pim/M} as §2. \textbf{But this is exactly the §2
mistake repeated: a period change rephrased as a ``perihelion
advance.''} Corda's own Eq. (31), applied to his own Eq. (32) force,
\emph{contradicts} the §3 conclusion.
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textbackslash{}vec R = \textbackslash{}frac\{m\textbackslash{}vec r\_m + M\textbackslash{}vec r\_M\}\{M + m\},\textbackslash{}qquad}
\NormalTok{\textbackslash{}vec r = \textbackslash{}vec r\_m {-} \textbackslash{}vec r\_M                                       \textbackslash{}qquad (43)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{J = \textbackslash{}mu r\^{}2 \textbackslash{}omega = 2\textbackslash{}mu\textbackslash{},\textbackslash{}dot A                                  \textbackslash{}qquad (45)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{T = 2\textbackslash{}pi\textbackslash{}!\textbackslash{}sqrt\{\textbackslash{}frac\{a\^{}3\}\{G M\_T\}\},\textbackslash{}quad M\_T = M + m              \textbackslash{}qquad (53)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textbackslash{}frac\{a\^{}3\}\{T\^{}2\} = \textbackslash{}frac\{G(M+m)\}\{4\textbackslash{}pi\^{}2\}                            \textbackslash{}qquad (54)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{T = T\_0 (1 + m/M)\^{}\{{-}1/2\}                                           \textbackslash{}qquad (57)}
\end{Highlighting}
\end{Shaded}
...
Corda then writes Eq. (59)
\texttt{phi\ =\ omegaT\_0\ \textasciitilde{}=\ 2pi(1\ +\ m/(2M))} and
calls the excess a ``perihelion advance'' --- same conflation as §2.7.

\hypertarget{numerical-summary-of-cordas-three-approaches-234-all-give-the-same-deltaphi}{%
\subsubsection{§2.9 Numerical summary of Corda's three approaches
(§2/§3/§4 all give the same
Deltaphi)}\label{numerical-summary-of-cordas-three-approaches-234-all-give-the-same-deltaphi}}
...
\FunctionTok{Print}\OperatorTok{[}\StringTok{"Deltaphi = pim/M per orbit  = "}\OperatorTok{,} \FunctionTok{N}\OperatorTok{[}\NormalTok{dphiNewton}\OperatorTok{],} \StringTok{" rad"}\OperatorTok{]}\NormalTok{;}
\FunctionTok{Print}\OperatorTok{[}\StringTok{"Deltaphi = pim/M per century = "}\OperatorTok{,} \FunctionTok{N}\OperatorTok{[}\NormalTok{dphiNewton }\SpecialCharTok{*}\NormalTok{ orbitsPerCentury }\SpecialCharTok{*}\NormalTok{ radToArcsec}\OperatorTok{],} \StringTok{" arcsec"}\OperatorTok{]}\NormalTok{;}
\CommentTok{(* Result:                                                                       *)}
\CommentTok{(*   Deltaphi = pim/M per orbit  = 5.21424x10\^{}{-}\^{}7 rad                                     *)}
\CommentTok{(*   Deltaphi = pim/M per century = 44.6557 arcsec  \textless{}{-} Corda\textquotesingle{}s reported 44.39\textquotesingle{}\textquotesingle{}/c        *)}
\end{Highlighting}
\end{Shaded}
...
Corda himself shows the \texttt{pim/M} formula fails for non-Mercury
planets:
...
\CommentTok{(* Results:                                                                      *)}
\CommentTok{(*   Venus  formula prediction: 257.91 \textquotesingle{}\textquotesingle{}/c   vs observed  8.62\textquotesingle{}\textquotesingle{}/c  {-}\textgreater{}  30x too big *)}
\CommentTok{(*   Earth  formula prediction: 194.50 \textquotesingle{}\textquotesingle{}/c   vs observed  3.83\textquotesingle{}\textquotesingle{}/c  {-}\textgreater{}  51x too big *)}
\end{Highlighting}
\end{Shaded}

\begin{longtable}[]{@{}llll@{}}
\toprule\noalign{}
Planet & \texttt{pim/M} (Corda's formula) & Observed residual &
Discrepancy \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
...
{[}OK{]} 1.04x \textless- ``agreement'' \\
Venus & \texttt{257.91\textquotesingle{}\textquotesingle{}/c} &
\texttt{\textasciitilde{}=\ 8.62\textquotesingle{}\textquotesingle{}/c}
& {[}X{]} \textbf{30x too big} \\
Earth & \texttt{194.50\textquotesingle{}\textquotesingle{}/c} &
\texttt{\textasciitilde{}=\ 3.83\textquotesingle{}\textquotesingle{}/c}
& {[}X{]} \textbf{51x too big} \\
\end{longtable}
...
system and invalid for others. \textbf{The honest reading:
\texttt{pim/M} is not the perihelion advance for any planet, including
Mercury.}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{t\_g = \textbackslash{}sqrt\{g\_\{00\}(r\_0)\}\textbackslash{}, t\_l                                     \textbackslash{}qquad (60)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ds\^{}2 = \textbackslash{}left(1 {-} \textbackslash{}frac\{2GM\}\{r c\^{}2\}\textbackslash{}right)(c\textbackslash{},dt)\^{}2}
\NormalTok{       {-} \textbackslash{}left(1 + \textbackslash{}frac\{2GM\}\{r c\^{}2\}\textbackslash{}right)(dr\^{}2 + r\^{}2 d\textbackslash{}theta\^{}2 + r\^{}2 \textbackslash{}sin\^{}2\textbackslash{}theta\textbackslash{},d\textbackslash{}phi\^{}2)}
\NormalTok{                                                                   \textbackslash{}qquad (61)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{t\_g = \textbackslash{}sqrt\{1 {-} r\_g/r\_0\}\textbackslash{}, t\_l \textbackslash{};\textbackslash{}approx\textbackslash{}; \textbackslash{}left(1 {-} \textbackslash{}tfrac\{1\}\{2\}\textbackslash{}tfrac\{r\_g\}\{r\_0\}\textbackslash{}right) t\_l   \textbackslash{}qquad (62)}
\end{Highlighting}
\end{Shaded}

where \texttt{r\_g\ =\ 2GM/c\^{}2} is the Sun's gravitational radius
(\texttt{\textasciitilde{}=\ 2.95\ km}). Corda also asserts a
corresponding radial-distance contraction:
\texttt{r\_0\ -\textgreater{}\ r\_0(1\ -\ 1/2\ r\_g/r\_0)} (Eq. 63),
arguing from \texttt{r\ =\ ct}.
...
radius \texttt{R} is
\texttt{r\ \textasciitilde{}=\ R(1\ -\ GM/(c\^{}2R))} (a small
isotropic-to-areal coordinate shift), so there \emph{is} a
\texttt{1/2\ r\_g/r\_0} correction when comparing isotropic to areal
radial coordinates, but treating this as ``the CNO sees a different
distance because \texttt{r\ =\ ct}'' is non-standard. Worth flagging but
the final-result coefficient in Eq. (67) is unaffected to first order.

Substituting Eq. (63) into Eq. (17):

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{T\_F = \textbackslash{}frac\{2\textbackslash{}pi r\_0\^{}\{3/2\}\textbackslash{}left(1 {-} \textbackslash{}tfrac\{1\}\{2\}\textbackslash{}tfrac\{r\_g\}\{r\_0\}\textbackslash{}right)\^{}\{3/2\}(1 + m/M)\^{}\{{-}1/2\}\}\{\textbackslash{}sqrt\{GM\}\}  \textbackslash{}qquad (64)}
\end{Highlighting}
\end{Shaded}

Computing \texttt{omega\_F\ =\ 2pi/T\_F}:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textbackslash{}omega\_F \textbackslash{}simeq \textbackslash{}omega\textbackslash{}left(1 {-} \textbackslash{}tfrac\{1\}\{2\}\textbackslash{}tfrac\{r\_g\}\{r\_0\}\textbackslash{}right)\^{}\{{-}3/2\}\textbackslash{}!\textbackslash{}left(1 + \textbackslash{}tfrac\{1\}\{2\}\textbackslash{}tfrac\{r\_g\}\{r\_0\}\textbackslash{}right)   \textbackslash{}qquad (65)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textbackslash{}varphi\_F \textbackslash{}simeq 2\textbackslash{}pi\textbackslash{}left(1 + \textbackslash{}tfrac\{5\}\{4\}\textbackslash{}tfrac\{r\_g\}\{r\_0\}\textbackslash{}right)   \textbackslash{}qquad (66)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textbackslash{}boxed\{\textbackslash{};\textbackslash{}Delta\textbackslash{}varphi\_F \textbackslash{};\textbackslash{}simeq\textbackslash{}; \textbackslash{}tfrac\{5\textbackslash{}pi\}\{2\}\textbackslash{},\textbackslash{}tfrac\{r\_g\}\{r\_0\}\textbackslash{};\}  \textbackslash{}qquad (67)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{(* Result: 2 Pi + (5 Pi/2) x + O[x]\^{}2   [OK] leading is (5/2)pi r\_g/r\_0 *)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ds\^{}2 = c\^{}2 dt\^{}2 {-} dr\^{}2 {-} r\^{}2 d\textbackslash{}phi\^{}2 {-} dz\^{}2                       \textbackslash{}qquad (68)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textbackslash{}phi = \textbackslash{}phi\textquotesingle{} + \textbackslash{}omega t\textquotesingle{}                                           \textbackslash{}qquad (69)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ds\^{}2 = \textbackslash{}left(1 {-} \textbackslash{}tfrac\{r\^{}2\textbackslash{}omega\^{}2\}\{c\^{}2\}\textbackslash{}right)c\^{}2 dt\^{}2 {-} 2\textbackslash{}omega r\^{}2 d\textbackslash{}phi\textquotesingle{} dt\textquotesingle{} {-} dr\^{}2 {-} r\^{}2 d\textbackslash{}phi\textquotesingle{}\^{}2 {-} dz\textquotesingle{}\^{}2   \textbackslash{}qquad (70)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{d\textbackslash{}tau = \textbackslash{}sqrt\{1 {-} r\^{}2\textbackslash{}omega\^{}2/c\^{}2\}\textbackslash{},dt \textbackslash{};\textbackslash{}simeq\textbackslash{}; \textbackslash{}left(1 {-} \textbackslash{}tfrac\{1\}\{2\}\textbackslash{}tfrac\{r\^{}2\textbackslash{}omega\^{}2\}\{c\^{}2\}\textbackslash{}right) dt   \textbackslash{}qquad (71)}
\end{Highlighting}
\end{Shaded}

At \texttt{r\ =\ r\_0}, \texttt{omega\ =\ omega\_0}:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textbackslash{}tau \textbackslash{}simeq \textbackslash{}left(1 {-} \textbackslash{}tfrac\{1\}\{2\}\textbackslash{}tfrac\{r\_0\^{}2\textbackslash{}omega\_0\^{}2\}\{c\^{}2\}\textbackslash{}right) t   \textbackslash{}qquad (72)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textbackslash{}tau = \textbackslash{}sqrt\{1 {-} \textbackslash{}tfrac\{1\}\{2\}\textbackslash{}tfrac\{r\_g\}\{r\_0\}\}\textbackslash{}, t}
\NormalTok{     \textbackslash{}simeq \textbackslash{}left(1 {-} \textbackslash{}tfrac\{1\}\{4\}\textbackslash{}tfrac\{r\_g\}\{r\_0\}\textbackslash{}right) t        \textbackslash{}qquad (73)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{T\_T = T\_0 (1 + m/M)\^{}\{{-}1/2\}\textbackslash{},(1 {-} \textbackslash{}tfrac\{1\}\{2\} r\_g/r\_0)\^{}2           \textbackslash{}qquad (74)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textbackslash{}omega\_F = 2\textbackslash{}pi/T\_T \textbackslash{}simeq \textbackslash{}omega\textbackslash{},(1 {-} \textbackslash{}tfrac\{1\}\{2\} r\_g/r\_0)\^{}\{{-}2\} \textbackslash{}simeq \textbackslash{}omega\textbackslash{},(1 + \textbackslash{}tfrac\{3\}\{2\}\textbackslash{}, r\_g/r\_0)   \textbackslash{}qquad (75)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textbackslash{}varphi\_F = \textbackslash{}omega\_F T\_0 (1 {-} m/(2M)) \textbackslash{}simeq 2\textbackslash{}pi\textbackslash{}left(1 + \textbackslash{}tfrac\{3\}\{2\}\textbackslash{},\textbackslash{}tfrac\{r\_g\}\{r\_0\}\textbackslash{}right)  \textbackslash{}qquad (76)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textbackslash{}boxed\{\textbackslash{};\textbackslash{}Delta\textbackslash{}varphi\_F \textbackslash{};\textbackslash{}simeq\textbackslash{}; 3\textbackslash{}pi\textbackslash{},\textbackslash{}tfrac\{r\_g\}\{r\_0\}\textbackslash{};\}  \textbackslash{}qquad (77)}
\end{Highlighting}
\end{Shaded}
...
with \texttt{omega\ =\ 2pi/T} and the
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textbackslash{}Delta\textbackslash{}varphi\_\{\textbackslash{}rm GR\} = \textbackslash{}frac\{6\textbackslash{}pi GM\}\{c\^{}2 a (1{-}e\^{}2)\} = \textbackslash{}frac\{3\textbackslash{}pi r\_g\}\{a(1{-}e\^{}2)\}}
\end{Highlighting}
\end{Shaded}

For Mercury (\texttt{e\ =\ 0.20563},
\texttt{1\ -\ e\^{}2\ \textasciitilde{}=\ 0.9577}):
\texttt{Deltaphi\_GR\ =\ 42.99\textquotesingle{}\textquotesingle{}/century}.

For the \textbf{circular} limit (\texttt{e\ =\ 0}, \texttt{a\ =\ r\_0}):
\texttt{Deltaphi\_GR\ =\ 3pi\ r\_g/r\_0}. \textbf{Corda's Eq. (77)
reproduces the circular-orbit limit of GR.}
...
\NormalTok{radToArcsec }\ExtensionTok{=} \DecValTok{180}\SpecialCharTok{/}\FunctionTok{Pi} \SpecialCharTok{*} \FloatTok{3600.}\NormalTok{;}
\OperatorTok{\{}\StringTok{"Corda §8 (3pi r\_g/a, circular)"}\OperatorTok{,}  \DecValTok{3} \FunctionTok{Pi}\NormalTok{ rg}\SpecialCharTok{/}\NormalTok{aMerc }\SpecialCharTok{*}\NormalTok{ orbitsPerCentury }\SpecialCharTok{*}\NormalTok{ radToArcsec}\OperatorTok{,}
 \StringTok{"GR Mercury  (3pi r\_g/[a(1{-}e\^{}2)])"}\OperatorTok{,} \DecValTok{3} \FunctionTok{Pi}\NormalTok{ rg}\SpecialCharTok{/}\NormalTok{(aMerc (}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ eMerc}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{)) }\SpecialCharTok{*}\NormalTok{ orbitsPerCentury }\SpecialCharTok{*}\NormalTok{ radToArcsec}\OperatorTok{\}}
\CommentTok{(* Results:                                                                  *)}
...
Corda's §§6--8 derivation is missing the \texttt{1/(1-e\^{}2)}
...
of Eq. (32) --- gives \texttt{phi\_0\ =\ 2pi} exactly: -
\texttt{F\ =\ -k/r\^{}2} =\textgreater{}
\texttt{F\textquotesingle{}(r)\ r\ /\ F(r)\ =\ -2} =\textgreater{}
\texttt{phi\_0\ =\ 2pi/sqrt(3\ -\ 2)\ =\ 2pi}. {[}OK{]} -
\texttt{F\ =\ (1+m/M)(-k/r\^{}2)} =\textgreater{} same
\texttt{F\textquotesingle{}/F\ =\ -2/r} =\textgreater{} same
\texttt{phi\_0\ =\ 2pi}. {[}OK{]}

This is Bertrand's theorem: of all central potentials, \emph{only}
\texttt{1/r} (Kepler / Newton) and \texttt{r\^{}2} (harmonic) give
closed bound orbits universally. Inverse-square forces (Newton's
gravity, Eq. 9) produce closed ellipses with no precession at any energy
or angular momentum. Constant rescaling of an inverse-square force does
not change this --- it just changes the orbital period.

\textbf{Therefore Eq. (20)'s \texttt{Deltaphi\ =\ pim/M} is not an
apsidal precession.} It is the angle by which Mercury's \emph{position}
differs from \texttt{2pi} when measured at time \texttt{T\_0} (the
unperturbed period) under the perturbed angular velocity \texttt{omega}.
After the true perturbed period \texttt{T\ =\ T\_0(1+m/M)\^{}(-1/2)} has
elapsed, Mercury has swept exactly \texttt{2pi} again and returned to
perihelion. \textbf{No precession.}
...
Applying Corda's own formula
\texttt{Deltaphi\ =\ pim/M\ x\ (orbits/century)} to Venus and Earth:
...
Planet
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\texttt{m\ x\ orbits/c\ x\ radToArcsec\ /\ Msun\ x\ pi}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
Observed
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
Discrepancy
...
doesn't work as a defence: - The formula \texttt{Deltaphi\ =\ pim/M}
makes no reference to n-body effects. - The derivation in §§2/3/4 is
strictly two-body throughout (no interior planets enter). - If the
formula were the correct two-body result, it would apply to any two-body
sub-problem and the n-body corrections would be smaller perturbations
--- not corrections of \texttt{factor\ 30–50}.

\textbf{{[}for Tepper:{]}} the strongest available evidence that
\texttt{pim/M} is not the correct two-body perihelion advance is that
the formula is empirically wrong for every planet other than Mercury.
The Mercury ``agreement'' is coincidence at
\texttt{m/M\ \textasciitilde{}=\ 1.66\ x\ 10\^{}-\^{}7} happening to
give a number near \texttt{43\textquotesingle{}\textquotesingle{}/c}
once multiplied by Mercury's \texttt{415.2\ orbits/century}. Venus and
Earth have different \texttt{(m/M,\ orbits/c)} products and give wildly
wrong predictions.
...
Corda's Eq. (77) \texttt{Deltaphi\_F\ =\ 3pi\ r\_g/r\_0} is correct
algebra (modulo the §2.13 typo) but recovers only the circular-orbit
limit of the true GR result \texttt{3pi\ r\_g/{[}a(1-e\^{}2){]}}. For
Mercury (e = 0.21) this is a 4.4\% shortfall
(\texttt{-1.82\textquotesingle{}\textquotesingle{}/century}).
...
(smaller \texttt{e}), \texttt{3pi\ r\_g/a} is much closer to the full GR
answer.
...
\texttt{pim/M} that doesn't correspond to a real precession; the two
together don't add up to GR --- the \texttt{pim/M} is just spurious.
...
adding the dual-theory \texttt{(1\ +\ V/(mc\^{}2))} factor to the force
law:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{a\_m = {-}\textbackslash{}frac\{GM\}\{r\^{}2\}\textbackslash{}left(1 {-} \textbackslash{}frac\{GM\}\{c\^{}2 r\}\textbackslash{}right)\textbackslash{}hat u\_r   \textbackslash{}qquad (\textbackslash{}text\{Eq. h4\})}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textbackslash{}Delta\textbackslash{}varphi\_d = 2\textbackslash{}pi\textbackslash{}!\textbackslash{}left[\textbackslash{}left(1 + \textbackslash{}tfrac\{m\}\{M\}\textbackslash{}right)}
\NormalTok{                  \textbackslash{}left(1 {-} \textbackslash{}tfrac\{G(M\^{}2 + m\^{}2)\}\{(M+m) c\^{}2 r\_0\}\textbackslash{}right)\textbackslash{}right]\^{}\{1/2\} {-} 2\textbackslash{}pi}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textbackslash{}Delta\textbackslash{}varphi\_\{d\_1\} \textbackslash{};\textbackslash{}simeq\textbackslash{}; 2\textbackslash{}pi\textbackslash{}!\textbackslash{}left[\textbackslash{}frac\{m\}\{2M\} {-} \textbackslash{}frac\{GM(1+m/M)\}\{2 c\^{}2 r\_0\}\textbackslash{}right]}
\end{Highlighting}
\end{Shaded}
...
coincidence on top of a coincidence}: \texttt{pim/M} is fictitious, and
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{F(r) = {-}\textbackslash{}frac\{GMm\}\{r\^{}2\}\textbackslash{}left(1 {-} \textbackslash{}frac\{GM\}\{c\^{}2 r\}\textbackslash{}right)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\textbackslash{}boxed\{\textbackslash{};\textbackslash{}Delta\textbackslash{}varphi\_\{\textbackslash{}rm framework\}\^{}\{\textbackslash{}rm genuine\}}
\NormalTok{       \textbackslash{};=\textbackslash{}; {-}\textbackslash{}frac\{1\}\{6\}\textbackslash{},\textbackslash{}Delta\textbackslash{}varphi\_\{\textbackslash{}rm GR\}}
\NormalTok{       \textbackslash{};=\textbackslash{}; {-}7.17\textbackslash{},\textbackslash{}text\{\textquotesingle{}\textquotesingle{}/century\}\textbackslash{};\}}
\end{Highlighting}
\end{Shaded}
...
term (since \texttt{GM/(c\^{}2r)} scales with the attracting mass and
the other planets are light). The
...
The Corda-style \texttt{pim/M\ +\ relativistic\ correction} template
that \emph{Relativistic Newtonian Theory} inherits should be replaced by
the apsidal-angle calculation as the framework's genuine perihelion
...
adds a \texttt{(1\ +\ V/(mc\^{}2))}-style factor to the force without
modifying the spatial metric. The 12\% near-miss in PR \#83 doc 03 is an
artefact of taking Corda's \texttt{pim/M} heuristic as the baseline.
...
\item
  ...
  \texttt{phi\_0\ =\ 2pi}, i.e.\textasciitilde no apsidal precession?
  This is the load-bearing critique of §§2--4. If you read Bertrand
  differently or identify a step in Eq. (31)'s derivation that doesn't
  apply, please flag.
\item
  \textbf{Period vs.~precession.} Do you agree that the \texttt{pim/M}
  in Corda's Eqs. (19)--(20) is computing the angle Mercury sweeps in
  the \emph{unperturbed} period \texttt{T\_0} at the \emph{perturbed}
  angular velocity \texttt{omega} --- not the rotation of the orbit's
  major axis between successive perihelia? This is the conceptual
  distinction that determines whether \emph{Relativistic Newtonian
  Theory} inherits a fictitious baseline.
\item
  \textbf{§5 self-refutation.} The same \texttt{pim/M} formula gives
...
\item
  \textbf{§§6--8 vs.~eccentricity.} Corda's \texttt{3pi\ r\_g/r\_0}
  reproduces the e=0 GR limit and misses \texttt{1/(1-e\^{}2)}. For
  Mercury this is a 4.4\% shortfall. Do you read §§6--8 as a valid
  pedagogical derivation of the circular-orbit GR result (PPN sum of
  gravitational + Doppler TD), or as a complete GR derivation? The
  distinction matters for whether the eccentricity correction needs to
  be added to the framework's prediction.
\item
  ...
  \texttt{a\ =\ -(GM/r\^{}2)(1\ -\ GM/(c\^{}2r)).ê\_r} is the proper
...
\item
  Corda's §§2--4 result \texttt{Deltaphi\ =\ pim/M} is \emph{not} a
  perihelion advance --- it is a period-and-angular-velocity rescaling
  that does not change the apsidal angle of a closed inverse-square
  orbit. This is verified via Corda's own Eq. (31).
\item
...
\item
  ...
  inherits the Corda framing's fictitious \texttt{pim/M} baseline plus a
